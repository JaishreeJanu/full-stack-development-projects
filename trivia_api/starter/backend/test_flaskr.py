...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format('jaishree','dabli123','localhost:5432', 'trivia_test')
    ...
    def test_play_quiz(self):
        res = self.client().post('/quizzes',json={'previous_questions':[1,2,3],'quiz_category':{'id':2}})
        data = json.loads(res.data)
