...
class CastingTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #database_path = "postgres://{}:{}@{}/{}".format('jaishree','dabli123','localhost:5432', database_name)
    ...
    def test_add_actor_400(self):
        ...
        res = self.client().post('/actors', json = this_actor, headers=director_auth_header)
        data = json.loads(res.data)
    ...
    def test_get_actors(self):
        ...
        res = self.client().get('/actors?page=1', headers = assistant_auth_header)
        data = json.loads(res.data)
    ...
    def test_get_actors_404(self):
        ...
        res = self.client().get('/actors?page=100', headers = assistant_auth_header)
        data = json.loads(res.data)
    ...
    def test_modify_actors(self):
        ...
        res = self.client().patch('/actors/1', json = this_actor , headers = producer_auth_header)
        data = json.loads(res.data)
    ...
    def test_modify_actors_403(self):
        ...
        res = self.client().patch('/actors/1', json = this_actor, headers = assistant_auth_header)
        data = json.loads(res.data)
    ...
    def test_get_movies_404(self):
        ...
        res = self.client().get('/movies?page=100', headers = assistant_auth_header)
        data = json.loads(res.data)
    ...
    def test_modify_movies(self):
        ...
        res = self.client().patch('/movies/1', json = this_movie , headers = producer_auth_header)
        data = json.loads(res.data)
    ...
    def test_modify_movies_403(self):
        ...
        res = self.client().patch('/movies/1', json = this_movie, headers = assistant_auth_header)
        data = json.loads(res.data)
